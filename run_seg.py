...
#from mmengine import Config,get_git_hash
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--config',
        default='configs/cdda/gta2cs_cdda_daformer.py',
        help='Path to config file',
    )
    parser.add_argument(
        '--not_get_images',
        action="store_true",
        help='get preprocessed images or not',
    )
    parser.add_argument(
        '--not_get_distributions',
        action="store_true",
        help='get depth distribution or not',
    )
    parser.add_argument(
        '--dataset_name',
        default='gta',
    ...
    parser.add_argument(
        '--source_preprocessed_path',
        default='preprocessed/gta_daformer',
