...
uda = dict(
    ...
    matrix_path='preprocessed/gta_hrda/gta_24966_distribution.pth',

    # training pictures path
    croped_images_path='preprocessed/gta_hrda/images',
    croped_labels_path='preprocessed/gta_hrda/labels',
