...
uda = dict(
    ...
    matrix_path='preprocessed/synthia_hrda/synthia_9400_distribution.pth',

    # training pictures path
    croped_images_path='preprocessed/synthia_hrda/images',
    croped_labels_path='preprocessed/synthia_hrda/labels',
...
name = 'synthiaHR2csHR_cdda_hrda_s1'
exp = 'basic'
